...
export default function PokemonPickerItem({ pokemon, onDragStart }: PokemonPickerItemProps) {
  ...
  return (
    <div
      ...
      className="group relative flex flex-col overflow-hidden rounded-2xl bg-white/5 backdrop-blur-md border border-white/10 shadow-lg hover:shadow-2xl hover:scale-[1.03] transition-all duration-300 ease-out cursor-grab active:cursor-grabbing"
    >
      <div
